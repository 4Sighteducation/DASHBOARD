-- Create function to calculate all statistics with fixed GROUP BY
...
BEGIN
    ...
    -- Also calculate question-level statistics
    ...
    GROUP BY s.establishment_id, qr.question_id, qr.cycle, e.is_australian;
