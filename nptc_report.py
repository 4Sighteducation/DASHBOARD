#!/usr/bin/env python3
"""
Neath & Port Talbot Colleges - Comparative Analysis Report Generator
Generates comprehensive analysis of VESPA data across cycles and faculties
"""
...
class NPTCAnalyzer:
    def __init__(self):
        """Initialize the NPTC data analyzer"""
    ...
    def _clean_data(self):
        ...
        faculty_names = {
            'SFA': 'Sport, Fitness & Adventure',
            'CVP': 'Creative & Visual Performance',
            'SPS': 'Social & Public Services',
            'BTM': 'Business, Tourism & Management',
            'HSC': 'Health & Social Care',
            'HAT': 'Hair & Therapy',
            'CIT': 'Computing & IT',
            'ENG': 'Engineering',
            'CHA': 'Construction, Hospitality & Auto',
            'BES': 'Basic & Essential Skills'
        }
    ...
    def _create_faculty_radar(self):
        ...
        faculty_names = {
            ...
            'CVP': 'Creative & Visual',
            'SPS': 'Public Services',
            'BTM': 'Business & Tourism',
            'HSC': 'Health & Social',
            'HAT': 'Hair & Therapy',
            'CIT': 'Computing & IT',
            'ENG': 'Engineering',
            'CHA': 'Construction & Hosp.',
            'BES': 'Basic Skills',
        ...
        for element in self.vespa_categories + ['Overall']:
            ...
            for cycle in [1, 2, 3]:
                ...
                if col_name in self.results_df.columns:
                    ...
                    if len(scores) > 0:
                        # Calculate NPTC distribution counts
                        nptc_counts = []
                        for score in range(1, 11):
                            count = ((scores >= score - 0.5) & (scores < score + 0.5)).sum()
                            nptc_counts.append(count)
                        
                        # Convert to percentages
                        total_nptc = sum(nptc_counts)
                        nptc_percentages = [count/total_nptc * 100 if total_nptc > 0 else 0 for count in nptc_counts]
                        ...
                        # Add means
                        nptc_mean = scores.mean()
                        national_mean = self.national_stats.get(cycle_key, {}).get(element, {}).get('mean', 5.5)
                        
                        fig.add_annotation(
                            x=5.5, y=max(nptc_percentages + national_percentages) * 1.1,
                            text=f"NPTC: {nptc_mean:.1f}<br>National: {national_mean:.1f}",
                            showarrow=False,
                            font=dict(size=10),
                            row=1, col=cycle
                        )
    ...
    def generate_ai_analysis(self, analysis_results):
        ...
        ai_analysis['recommendations'] = [
            ...
            },
            {
                ...
                'description': 'Develop targeted strategies for smaller faculties (Engineering, Computing) to ensure equitable support.'
            }
        ]
    ...
    def generate_html_report(self, analysis_results, figures):
        """Generate comprehensive HTML report with NPTC branding"""
...
<head>
    ...
    <title>Neath & Port Talbot Colleges - VESPA Comparative Analysis Report</title>
    ...
    <div class="container">
            <div class="report-header">
                <div style="display: flex; align-items: center; justify-content: space-between; margin-bottom: 20px;">
                    <img src="https://moodle.nptcgroup.ac.uk/file.php/79/NPTC_Logo.jpg" 
                         alt="NPTC Group Logo" 
                ...
                <h1 style="color: #2c3e50; margin-bottom: 10px;">Neath & Port Talbot Colleges</h1>
        ...
        <div class="executive-summary">
            ...
            <p>This comprehensive VESPA analysis for Neath & Port Talbot Colleges examines student mindset and study skills development 
            ...
            <div class="key-insights" style="margin-top: 25px;">
                ...
                <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(300px, 1fr)); gap: 20px; margin-top: 20px;">
                    ...
                    <div style="background: rgba(114, 203, 68, 0.08); padding: 20px; border-radius: 8px; border-left: 4px solid #72cb44;">
                        ...
                        <p>Hair & Therapy leads with 8.67 overall score, while Computing & IT shows opportunity for targeted support at 5.00. 
                        Sport & Fitness has the largest cohort (823 students) with solid performance.</p>
                    </div>
                ...
                <div style="margin-top: 25px; padding: 20px; background: linear-gradient(to right, rgba(102, 126, 234, 0.05), rgba(118, 75, 162, 0.05)); border-radius: 8px;">
                    ...
                    <ul style="margin: 0; padding-left: 25px; line-height: 1.8;">
                        ...
                        <li><strong>Long-term:</strong> Share best practices from high-performing faculties (Hair & Therapy, Construction)</li>
...
"""
        ...
        <div class="section">
            ...
            <p>Distribution of VESPA scores showing all 3 cycles for each element. Bar charts show NPTC percentages, red lines show national distribution.</p>
"""
...
"""
    ...
    def run_analysis(self):
        ...
        print("\n" + "="*60)
        print("NEATH & PORT TALBOT COLLEGES - VESPA ANALYSIS")
        print("="*60 + "\n")
        ...
        # Save report
        report_filename = f'NPTC_Report_{datetime.now().strftime("%Y%m%d_%H%M%S")}.html'
